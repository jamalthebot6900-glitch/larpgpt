...
export default function LarpOfTheDay() {
  ...
  return (
    <div
      className="max-w-[680px] w-full mx-auto mb-8 rounded-xl overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="px-4 py-3">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-sm font-semibold">{lotd.persona}</span>
        ...
        <div className="flex gap-4 text-xs" style={{ color: "var(--text-muted)" }}>
          <span>
            ❤️ <span style={{ color: "var(--gold)", fontWeight: 600 }}>{lotd.likes}</span>
          </span>
          <span>
